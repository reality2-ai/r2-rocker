...
| `tools/r2-rocker-tg/` | ✅ TG keygen/verify/inspect |
...
identified that r2-rocker's firmware and dashboard are monolithic
...
* The "gap" is really a **documentation gap**: we haven't yet
  authored the `r2-rocker.ensemble.yaml` (per R2-DEF §7) that
...
0. **Trust topology — TWO trust groups, related by bilateral
   ...
   implementation of the entanglement scope (`SPEC-R2-ROCKER-BRIDGE.md`).
